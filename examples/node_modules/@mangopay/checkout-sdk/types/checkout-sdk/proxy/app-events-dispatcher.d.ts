...
import {
  ...
  CheckoutSdkEventsDispatcher,
  CheckoutSdkFrameEventMap,
  CheckoutSdkProxyMessagesOf,
} from '@mangopay/checkout-sdk-hosted-core';
import { AppEventsDispatcherEventMap } from './app-events-dispatcher-event-map';
import { CheckoutSdkInstance } from '../checkout-sdk-instance';
export declare class AppEventsDispatcher
  extends CheckoutSdkEventsDispatcher<CheckoutSdkHostEventMap, CheckoutSdkFrameEventMap>
  implements CheckoutSdkInstance
{
  ...
  umount(): void;
  on<T extends keyof AppEventsDispatcherEventMap>(
    type: T,
    callback: (event: AppEventsDispatcherEventMap[T]) => void
  ): () => void;
  disable(): void;
  enable(): void;
