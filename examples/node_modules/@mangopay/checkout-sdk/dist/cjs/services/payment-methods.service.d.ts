import { CreateCardPayment, CreateCardRegistration, CreatePaypalPayment, PaymentMethod, PaymentMethodType, ValidateApplePayMerchant } from '@mangopay/checkout-sdk-elements-core';
...
export declare class PaymentMethodsService {
    ...
    getCallbackFn(fnName: keyof StoredCallbacks): ((input: import("@mangopay/checkout-sdk-elements-core").ValidateApplePayMerchantInput) => Promise<import("@mangopay/checkout-sdk-elements-core").ApplePayMerchantSession>) | ((cardType?: string | undefined) => Promise<import("@mangopay/checkout-sdk-elements-core").CreateCardRegistrationResult>) | ((data?: any) => Promise<import("@mangopay/sdk-authorize").CreateCardDirectPayInResult>) | ((profilingAttemptReference?: string | undefined) => Promise<import("@mangopay/checkout-sdk-elements-core").CreatePaypalPaymentResult>) | undefined;
